...
public interface JavaParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code EnhancedForControlControl}
	 * labeled alternative in {@link JavaParser#forControl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEnhancedForControlControl(JavaParser.EnhancedForControlControlContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ForInitControl}
	 * labeled alternative in {@link JavaParser#forControl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitForInitControl(JavaParser.ForInitControlContext ctx);
	/**
