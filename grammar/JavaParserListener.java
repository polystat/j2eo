...
public interface JavaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code EnhancedForControlControl}
	 * labeled alternative in {@link JavaParser#forControl}.
	 * @param ctx the parse tree
	 */
	void enterEnhancedForControlControl(JavaParser.EnhancedForControlControlContext ctx);
	/**
	 * Exit a parse tree produced by the {@code EnhancedForControlControl}
	 * labeled alternative in {@link JavaParser#forControl}.
	 * @param ctx the parse tree
	 */
	void exitEnhancedForControlControl(JavaParser.EnhancedForControlControlContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ForInitControl}
	 * labeled alternative in {@link JavaParser#forControl}.
	 * @param ctx the parse tree
	 */
	void enterForInitControl(JavaParser.ForInitControlContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ForInitControl}
	 * labeled alternative in {@link JavaParser#forControl}.
	 * @param ctx the parse tree
	 */
	void exitForInitControl(JavaParser.ForInitControlContext ctx);
	/**
