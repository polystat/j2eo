...
class Translator(
    ...
    private fun mapSimpleCompilationUnit(
        ...
        val eoAliases =
            preprocessorState.eoClassesForCurrentAlias
                .map { EOMeta("alias", it) }
                .toList()
    ...
    private fun mapTopLevelComponent(
        component: TopLevelComponent,
        context: Context,
    ): org.polystat.j2eo.eotree.EOBnd =
    ...
    private fun mapImport(
        ...
        context: Context,
    ): EOMeta = EOMeta("alias", importDecl.compoundName.names.joinToString("."))
}
